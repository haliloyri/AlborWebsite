  ...
  documents: {
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Email address: entered directly by you and stored in the Supabase database.",
        ...
        },
        {
          ...
          paragraphs: [
            "Albor does not create a password-based login account. Your name and surname stay on your device. Your email address is stored in Supabase together with your reading activity and badges as a cloud profile record.",
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            `You may ask to access, correct, or delete the email address, reading history, and badge information held in Supabase by emailing ${email}. To protect your data, Albor may ask you to verify the email address connected to the record.`,
            "Your name, surname, and audio recordings are controlled on your device and are not included in the cloud deletion process. You may stop future collection by discontinuing use of Albor.",
          ],
        },
        {
          title: "9. Children",
    ...
    support: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [`For access, correction, or deletion of your cloud-stored email address, reading history, and badges, use the Data Deletion page or email ${email}. Name, surname, and audio recordings remain on your device.`],
        },
        {
          title: "Developer",
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "4. Your information", paragraphs: ["You are responsible for the accuracy of the details you enter. Your name and surname stay locally on your device; your email address is stored in Supabase. Albor does not provide a password-based login account. The handling of your information is described in the Privacy Policy."] },
      ...
      sections: [
        {
          ...
          bullets: ["Your email address stored in Supabase.", "Your stored reading history.", "Your earned badge records."],
        },
        {
        ...
        },
        {
          ...
          paragraphs: ["Your name, surname, and audio recordings are stored locally and are not uploaded to Supabase. Remove them using the available app or device controls. Uninstalling the app normally removes app-local data, subject to your device and backup settings."],
        },
        {
  ...
  documents: {
    privacy: {
      ...
      sections: [
        ...
        { title: "4. Konten und Identifizierung", paragraphs: ["Albor erstellt kein passwortbasiertes Anmeldekonto. Vor- und Nachname bleiben auf deinem Gerät. Die E-Mail-Adresse wird zusammen mit Leseaktivität und Abzeichen als Cloud-Profil in Supabase gespeichert."] },
        ...
        { title: "8. Deine Rechte", paragraphs: [`Du kannst unter ${email} Auskunft, Berichtigung oder Löschung von E-Mail-Adresse, Leseverlauf und Abzeichen in Supabase verlangen. Zur Sicherheit kann die mit dem Datensatz verbundene E-Mail-Adresse verifiziert werden.`, "Vorname, Nachname und Audioaufnahmen werden auf deinem Gerät verwaltet und sind nicht Teil der Cloud-Löschung. Du kannst die künftige Erhebung beenden, indem du Albor nicht mehr nutzt."] },
    ...
    support: {
      ...
      sections: [
        ...
        { title: "Datenschutz und Löschung", paragraphs: [`Für Auskunft, Berichtigung oder Löschung von E-Mail-Adresse, Leseverlauf und Abzeichen in der Cloud nutze die Seite Datenlöschung oder schreibe an ${email}. Vor- und Nachname sowie Audioaufnahmen bleiben auf deinem Gerät.`] },
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "4. Deine Angaben", paragraphs: ["Du bist für die Richtigkeit deiner Angaben verantwortlich. Vor- und Nachname bleiben lokal auf deinem Gerät; die E-Mail-Adresse wird in Supabase gespeichert. Albor bietet kein passwortbasiertes Anmeldekonto. Die Datenverarbeitung ist in der Datenschutzerklärung beschrieben."] },
    ...
    deletion: {
      ...
      updated: "18. Juli 2026",
      sections: [
        { title: "Löschbare Cloud-Daten", bullets: ["In Supabase gespeicherte E-Mail-Adresse.", "Gespeicherter Leseverlauf.", "Gespeicherte Abzeichen."] },
  ...
  documents: {
    privacy: {
      ...
      sections: [
        ...
        { title: "4. Cuentas e identificación", paragraphs: ["Albor no crea una cuenta de acceso con contraseña. El nombre y los apellidos permanecen en tu dispositivo. El correo se guarda en Supabase junto con la actividad de lectura y las insignias como registro de perfil en la nube."] },
        ...
        { title: "8. Tus opciones y derechos", paragraphs: [`Puedes solicitar acceso, corrección o eliminación del correo, historial e insignias guardados en Supabase escribiendo a ${email}. Para proteger tus datos, Albor puede verificar el correo vinculado al registro.`, "El nombre, los apellidos y las grabaciones se controlan en tu dispositivo y no forman parte de la eliminación en la nube. Puedes detener la recopilación futura dejando de usar Albor."] },
    ...
    support: {
      ...
      sections: [
        ...
        { title: "Privacidad y eliminación", paragraphs: [`Para acceder, corregir o eliminar el correo, historial e insignias guardados en la nube, utiliza la página de Eliminación de datos o escribe a ${email}. El nombre, los apellidos y las grabaciones permanecen en tu dispositivo.`] },
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "4. Tu información", paragraphs: ["Eres responsable de la exactitud de los datos que introduces. El nombre y los apellidos permanecen localmente en tu dispositivo; el correo se guarda en Supabase. Albor no ofrece una cuenta con contraseña. El tratamiento se describe en la Política de privacidad."] },
    ...
    deletion: {
      ...
      updated: "18 de julio de 2026",
      sections: [
        { title: "Datos en la nube que pueden eliminarse", bullets: ["Correo electrónico guardado en Supabase.", "Historial de lectura almacenado.", "Registros de insignias obtenidas."] },
  ...
  documents: {
    privacy: {
      ...
      sections: [
        ...
        { title: "4. Hesap ve kimliklendirme", paragraphs: ["Albor parola ile giriş yapılan bir kullanıcı hesabı oluşturmaz. Ad ve soyadınız cihazınızda kalır. E-posta adresiniz; okuma etkinliğiniz ve rozetlerinizle birlikte bir bulut profil kaydı olarak Supabase’de saklanır."] },
        ...
        { title: "7. Saklama, güvenlik ve yurt dışı işleme", paragraphs: ["Bulut verileri Albor’u sunmak, talepleri sonuçlandırmak ve yasal yükümlülükleri yerine getirmek için gerekli olduğu sürece ya da geçerli bir silme talebi tamamlanana kadar saklanır. Ad, soyad ve ses kayıtları; mevcut uygulama veya cihaz kontrolleriyle kaldırılana kadar yalnızca cihazınızda kalır. Cihaz yedekleme ayarlarınız farklı sonuç doğurabilir.", "Supabase altyapısının bulunduğu ülkelerde veri işlenebilir. Makul teknik ve idari önlemler uygulanır; ancak hiçbir saklama veya aktarım yöntemi için mutlak güvenlik garanti edilemez."] },
        { title: "8. Tercihleriniz ve haklarınız", paragraphs: [`Supabase’de tutulan e-posta adresi, okuma geçmişi ve rozetler için erişim, düzeltme veya silme talebinizi ${email} adresine gönderebilirsiniz. Verinizi korumak için kayıtla ilişkili e-posta adresini doğrulamanız istenebilir.`, "Ad, soyad ve ses kayıtları cihazınızdan yönetilir ve bulut silme sürecine dahil değildir. Albor’u kullanmayı bırakarak gelecekteki veri toplamayı durdurabilirsiniz."] },
    ...
    support: {
      ...
      sections: [
        ...
        { title: "Gizlilik ve veri silme", paragraphs: [`Bulutta saklanan e-posta adresi, okuma geçmişi ve rozetlerinize erişim, düzeltme veya silme için Veri Silme sayfasını kullanın ya da ${email} adresine yazın. Ad, soyad ve ses kayıtları cihazınızda kalır.`] },
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "4. Girdiğiniz bilgiler", paragraphs: ["Girdiğiniz bilgilerin doğruluğundan siz sorumlusunuz. Ad ve soyad yalnızca cihazınızda tutulur; e-posta adresi Supabase’de saklanır. Albor parola tabanlı bir giriş hesabı sunmaz. Bilgilerinizin işlenmesi Gizlilik Politikası’nda açıklanır."] },
    ...
    deletion: {
      ...
      updated: "18 Temmuz 2026",
      sections: [
        { title: "Silinebilen bulut verileri", bullets: ["Supabase’de saklanan e-posta adresiniz.", "Saklanan okuma geçmişiniz.", "Kazandığınız rozet kayıtları."] },
