      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "In-app email address: entered directly by you and stored only on your device. Albor does not upload it to Supabase.",
            "Early-access email address: if you join through the website, your normalized email, selected language, consent version, verification result, and submission time are stored in Cloudflare D1.",
        ...
        },
        {
          ...
          bullets: [
            ...
            "To manage the early-access list and send an Albor invitation or essential early-access updates you requested.",
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "The Albor website uses Cloudflare for hosting, bot protection, and the D1 database that stores early-access requests. Cloudflare processes these records on Albor’s behalf.",
        ...
        },
        {
          ...
          paragraphs: [
            "Cloud data is retained for as long as it is needed to provide Albor, resolve requests, and meet legal obligations, or until a valid deletion request is completed. Early-access records are kept until the early-access process ends or you ask for deletion. Your in-app name, surname, email address, and audio recordings remain locally on your device until you remove them through available app or device controls, subject to your device backup settings.",
        ...
        },
        {
          ...
          paragraphs: [
            ...
            `You may withdraw from the early-access list and request deletion of your website submission at any time by emailing ${email}.`,
  ...
  documents: {
    privacy: {
      ...
      sections: [
        ...
        { title: "2. Von Albor erhobene Daten", bullets: ["Vor- und Nachname: von dir direkt eingegeben und ausschließlich auf deinem Gerät gespeichert; keine Übertragung an Supabase.", "E-Mail-Adresse in der App: von dir direkt eingegeben und ausschließlich auf deinem Gerät gespeichert; keine Übertragung an Supabase.", "E-Mail-Adresse für den Frühzugang: Bei einer Anmeldung über die Website werden die normalisierte E-Mail-Adresse, die gewählte Sprache, die Einwilligungsversion, das Prüfergebnis und der Zeitpunkt in Cloudflare D1 gespeichert.", "Leseaktivität: gelesene Geschichten, damit Albor Verlauf und Fortschritt anzeigen kann.", "Erfolge: verdiente Abzeichen, damit sie in der App angezeigt werden können.", "Audioaufnahmen: werden ausschließlich auf deinem Gerät gespeichert und nicht zu Supabase oder auf Albor-Server hochgeladen."] },
        { title: "3. Verwendungszwecke", bullets: ["Bereitstellung und Betrieb von Albor.", "Anzeige von Leseverlauf, Fortschritt und Abzeichen.", "Zuordnung der von dir eingegebenen Angaben zu deinen App-Daten.", "Verwaltung der Frühzugangsliste sowie Versand der angeforderten Einladung und notwendiger Frühzugangsinformationen.", "Bearbeitung von Support-, Datenschutz- und Löschanfragen.", "Schutz des Dienstes und Erfüllung gesetzlicher Pflichten."] },
        ...
        { title: "5. Drittanbieter", paragraphs: ["Albor nutzt Supabase als Datenbank- und Backend-Dienstleister. Supabase verarbeitet die oben beschriebenen Cloud-Daten im Auftrag von Albor und soll sie entsprechend dieser Erklärung und dem geltenden Recht schützen.", "Die Albor-Website nutzt Cloudflare für Hosting, Bot-Schutz und die D1-Datenbank für Frühzugangsanfragen. Cloudflare verarbeitet diese Daten im Auftrag von Albor.", "Zum Datum dieser Erklärung nutzt Albor keinen separaten Werbe-, Tracking-, Analyse- oder Crash-Reporting-Dienst. Bei Änderungen werden diese Erklärung und die App-Store-Angaben aktualisiert."] },
  ...
  documents: {
    privacy: {
      ...
      sections: [
        ...
        { title: "2. Información que recopila Albor", bullets: ["Nombre y apellidos: los introduces directamente y se guardan únicamente en tu dispositivo; no se suben a Supabase.", "Correo en la app: lo introduces directamente y se guarda únicamente en tu dispositivo; no se sube a Supabase.", "Correo de acceso anticipado: al registrarte en la web, el correo normalizado, el idioma, la versión del consentimiento, el resultado de verificación y la fecha se guardan en Cloudflare D1.", "Actividad de lectura: historias leídas para mostrar tu historial y progreso.", "Logros: insignias obtenidas para mostrarlas en tu experiencia.", "Grabaciones de audio: se guardan solo en tu dispositivo y no se suben a Supabase ni a servidores de Albor."] },
        { title: "3. Cómo se utiliza", bullets: ["Prestar y mantener el servicio de Albor.", "Mostrar historial, progreso e insignias.", "Relacionar los datos introducidos con tu actividad.", "Gestionar la lista y enviar la invitación o información esencial de acceso anticipado solicitada.", "Responder a solicitudes de soporte, privacidad y eliminación.", "Proteger el servicio y cumplir obligaciones legales."] },
        ...
        { title: "5. Servicios de terceros", paragraphs: ["Albor usa Supabase como proveedor de base de datos y backend. Supabase procesa en nombre de Albor la información en la nube descrita anteriormente y debe protegerla de acuerdo con esta política y la ley aplicable.", "La web de Albor usa Cloudflare para alojamiento, protección contra bots y la base D1 de solicitudes de acceso anticipado. Cloudflare trata estos datos por cuenta de Albor.", "En la fecha de esta política, Albor no utiliza un servicio independiente de publicidad, seguimiento, analítica o informes de fallos. Si cambia, se actualizarán esta política y las declaraciones de privacidad de App Store."] },
        ...
        { title: "7. Conservación y seguridad", paragraphs: ["Los datos en la nube se conservan mientras sean necesarios para prestar Albor, resolver solicitudes y cumplir obligaciones legales, o hasta completar una solicitud válida de eliminación. Los registros de acceso anticipado se guardan hasta que termine el proceso o solicites su eliminación. El nombre, los apellidos y las grabaciones permanecen localmente en tu dispositivo hasta que los elimines con los controles disponibles, sujeto a las copias de seguridad.", "Se aplican medidas razonables de seguridad, aunque ningún método puede garantizar seguridad absoluta."] },
        { title: "8. Tus opciones y derechos", paragraphs: [`Puedes solicitar acceso, corrección o eliminación de tu historial y tus insignias guardados en Supabase escribiendo a ${email}.`, `Puedes retirar tu solicitud de acceso anticipado y pedir la eliminación de tu registro web en cualquier momento escribiendo a ${email}.`, "El nombre, los apellidos, el correo y las grabaciones se controlan en tu dispositivo y no forman parte de la eliminación en la nube. Puedes detener la recopilación futura dejando de usar Albor."] },
  ...
  documents: {
    privacy: {
      ...
      sections: [
        ...
        { title: "7. Saklama, güvenlik ve yurt dışı işleme", paragraphs: ["Supabase’de tutulan okuma geçmişi ve rozetler Albor’u sunmak, talepleri sonuçlandırmak ve yasal yükümlülükleri yerine getirmek için gerekli olduğu sürece ya da geçerli bir silme talebi tamamlanana kadar saklanır. Erken erişim kayıtları süreç sona erene veya silme talebiniz tamamlanana kadar tutulur. Ad, soyad, uygulama içi e-posta adresi ve ses kayıtları; mevcut uygulama veya cihaz kontrolleriyle kaldırılana kadar yalnızca cihazınızda kalır. Cihaz yedekleme ayarlarınız farklı sonuç doğurabilir.", "Supabase ve Cloudflare altyapısının bulunduğu ülkelerde veri işlenebilir. Makul teknik ve idari önlemler uygulanır; ancak hiçbir saklama veya aktarım yöntemi için mutlak güvenlik garanti edilemez."] },
        { title: "8. Tercihleriniz ve haklarınız", paragraphs: [`Supabase’de tutulan okuma geçmişi ve rozetler için erişim, düzeltme veya silme talebinizi ${email} adresine gönderebilirsiniz.`, `Erken erişim listesinden ayrılmak ve internet sitesi başvurunuzun silinmesini istemek için dilediğiniz zaman ${email} adresine yazabilirsiniz.`, "Ad, soyad, uygulama içi e-posta adresi ve ses kayıtları cihazınızdan yönetilir ve bulut silme sürecine dahil değildir. Albor’u kullanmayı bırakarak gelecekteki veri toplamayı durdurabilirsiniz."] },
