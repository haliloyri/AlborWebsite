  ...
  documents: {
    privacy: {
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            "Name and email address: entered directly by you in the app and stored in the Supabase database.",
        ...
        },
        {
          ...
          paragraphs: [
            "Albor does not create a password-based login account. You enter your name and email address, and these details are stored as an app profile record together with your reading activity and badges.",
          ],
        },
        {
          title: "5. Third-party services",
          paragraphs: [
            "Albor uses Supabase as its database and backend service provider. Supabase processes the cloud-stored information described above on Albor’s behalf and is expected to protect it consistently with this policy and applicable law.",
        ...
        },
        {
          ...
          paragraphs: [
            "Cloud data is retained for as long as it is needed to provide Albor, resolve requests, and meet legal obligations, or until a valid deletion request is completed. Locally stored audio remains on your device until you remove it through available app or device controls, subject to your device backup settings.",
        ...
        },
        {
          ...
          paragraphs: [
            `You may ask to access, correct, or delete the name, email address, reading history, and badge information held about you by emailing ${email}. To protect your data, Albor may ask you to verify the email address connected to the record.`,
            "You may stop future collection by discontinuing use of Albor. Device-local audio is controlled on your device and is not included in the cloud deletion process.",
          ],
        },
        {
          title: "9. Children",
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "The email address entered in Albor when your request concerns cloud-stored data.",
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [`For access, correction, or deletion of your stored name, email address, reading history, and badges, use the Data Deletion page or email ${email}.`],
        },
        {
          title: "Developer",
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "4. Your information", paragraphs: ["You are responsible for the accuracy of the name and email address you enter. Albor does not provide a password-based login account. The handling of your information is described in the Privacy Policy."] },
      ...
      sections: [
        {
          ...
          bullets: ["Your name and email address.", "Your stored reading history.", "Your earned badge records."],
        },
        {
          title: "How to request deletion",
          paragraphs: [`Email ${email} from the email address you entered in Albor and use the subject “Albor Data Deletion Request.” State that you want the Albor profile data connected to that email address deleted.`],
        },
        {
          title: "Verification and completion",
          paragraphs: ["Albor may ask you to verify the email address connected to the record before deletion. After verification, the associated cloud data will be removed unless retention is legally required. You will receive confirmation when the request is completed."],
        },
        {
          title: "Audio recordings on your device",
          paragraphs: ["Audio recordings are stored locally and are not uploaded to Supabase. Remove them using the available app or device controls. Uninstalling the app normally removes app-local data, subject to your device and backup settings."],
        },
        {
  ...
  documents: {
    privacy: {
      ...
      sections: [
        ...
        { title: "4. Konten und Identifizierung", paragraphs: ["Albor erstellt kein passwortbasiertes Anmeldekonto. Name und E-Mail-Adresse werden als App-Profil zusammen mit Leseaktivität und Abzeichen gespeichert."] },
        ...
        { title: "7. Speicherung, Aufbewahrung und Sicherheit", paragraphs: ["Cloud-Daten werden so lange gespeichert, wie sie für Albor, Anfragen und gesetzliche Pflichten erforderlich sind, oder bis eine gültige Löschanfrage abgeschlossen ist. Lokale Audiodaten bleiben bis zur Entfernung über App- oder Gerätesteuerungen auf deinem Gerät; Gerätesicherungen können davon abweichen.", "Es werden angemessene Schutzmaßnahmen eingesetzt, vollständige Sicherheit kann jedoch bei keiner Speicherung oder Übertragung garantiert werden."] },
        { title: "8. Deine Rechte", paragraphs: [`Du kannst unter ${email} Auskunft, Berichtigung oder Löschung von Name, E-Mail-Adresse, Leseverlauf und Abzeichen verlangen. Zur Sicherheit kann die mit dem Datensatz verbundene E-Mail-Adresse verifiziert werden.`, "Du kannst die künftige Erhebung beenden, indem du Albor nicht mehr nutzt. Lokale Audioaufnahmen werden auf deinem Gerät verwaltet und sind nicht Teil der Cloud-Löschung."] },
    ...
    support: {
      ...
      sections: [
        ...
        { title: "Hilfreiche Angaben", bullets: ["Kurze Beschreibung des Problems.", "Gerätemodell und Betriebssystemversion, falls relevant.", "Bildschirm oder Funktion, bei der das Problem auftrat.", "Die in Albor eingegebene E-Mail-Adresse, wenn es um Cloud-Daten geht."] },
        ...
        { title: "Datenschutz und Löschung", paragraphs: [`Für Auskunft, Berichtigung oder Löschung von Name, E-Mail-Adresse, Leseverlauf und Abzeichen nutze die Seite Datenlöschung oder schreibe an ${email}.`] },
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "4. Deine Angaben", paragraphs: ["Du bist für die Richtigkeit von Name und E-Mail-Adresse verantwortlich. Albor bietet kein passwortbasiertes Anmeldekonto. Die Datenverarbeitung ist in der Datenschutzerklärung beschrieben."] },
    ...
    deletion: {
      ...
      updated: "18. Juli 2026",
      sections: [
        { title: "Löschbare Daten", bullets: ["Name und E-Mail-Adresse.", "Gespeicherter Leseverlauf.", "Gespeicherte Abzeichen."] },
        { title: "Löschung beantragen", paragraphs: [`Sende von der in Albor eingegebenen Adresse eine E-Mail an ${email} mit dem Betreff „Albor Data Deletion Request“ und bitte um Löschung der damit verbundenen Albor-Profildaten.`] },
        { title: "Verifizierung und Abschluss", paragraphs: ["Albor kann die E-Mail-Adresse vor der Löschung verifizieren. Danach werden die verbundenen Cloud-Daten entfernt, soweit keine gesetzliche Aufbewahrungspflicht besteht. Du erhältst eine Bestätigung."] },
        { title: "Audioaufnahmen auf deinem Gerät", paragraphs: ["Audioaufnahmen werden lokal gespeichert und nicht zu Supabase hochgeladen. Entferne sie über verfügbare App- oder Gerätesteuerungen. Eine Deinstallation entfernt normalerweise lokale App-Daten, abhängig von Geräte- und Sicherungseinstellungen."] },
  ...
  documents: {
    privacy: {
      ...
      sections: [
        ...
        { title: "4. Cuentas e identificación", paragraphs: ["Albor no crea una cuenta de acceso con contraseña. El nombre y el correo se guardan como un registro de perfil de la app junto con la actividad de lectura y las insignias."] },
        ...
        { title: "7. Conservación y seguridad", paragraphs: ["Los datos en la nube se conservan mientras sean necesarios para prestar Albor, resolver solicitudes y cumplir obligaciones legales, o hasta completar una solicitud válida de eliminación. El audio local permanece en el dispositivo hasta que lo elimines con los controles disponibles, sujeto a las copias de seguridad.", "Se aplican medidas razonables de seguridad, aunque ningún método puede garantizar seguridad absoluta."] },
        { title: "8. Tus opciones y derechos", paragraphs: [`Puedes solicitar acceso, corrección o eliminación de tu nombre, correo, historial e insignias escribiendo a ${email}. Para proteger tus datos, Albor puede verificar el correo vinculado al registro.`, "Puedes detener la recopilación futura dejando de usar Albor. El audio local se controla en tu dispositivo y no forma parte de la eliminación en la nube."] },
    ...
    support: {
      ...
      sections: [
        ...
        { title: "Qué incluir", bullets: ["Descripción breve del problema.", "Modelo del dispositivo y versión del sistema, si es relevante.", "Pantalla o función donde ocurrió.", "Correo introducido en Albor si la solicitud afecta a datos en la nube."] },
        ...
        { title: "Privacidad y eliminación", paragraphs: [`Para acceder, corregir o eliminar nombre, correo, historial e insignias, utiliza la página de Eliminación de datos o escribe a ${email}.`] },
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "4. Tu información", paragraphs: ["Eres responsable de la exactitud del nombre y correo que introduces. Albor no ofrece una cuenta con contraseña. El tratamiento se describe en la Política de privacidad."] },
    ...
    deletion: {
      ...
      updated: "18 de julio de 2026",
      sections: [
        { title: "Datos que pueden eliminarse", bullets: ["Nombre y correo electrónico.", "Historial de lectura almacenado.", "Registros de insignias obtenidas."] },
        { title: "Cómo solicitarlo", paragraphs: [`Envía un correo desde la dirección introducida en Albor a ${email} con el asunto “Albor Data Deletion Request” e indica que deseas borrar los datos del perfil vinculados a ese correo.`] },
        { title: "Verificación y finalización", paragraphs: ["Albor puede verificar el correo vinculado antes de eliminar. Tras verificarlo, se borrarán los datos en la nube salvo obligación legal de conservarlos y recibirás una confirmación."] },
        { title: "Grabaciones en tu dispositivo", paragraphs: ["Las grabaciones se guardan localmente y no se suben a Supabase. Elimínalas con los controles disponibles de la app o del dispositivo. Desinstalar la app suele eliminar los datos locales, según la configuración de copia de seguridad."] },
  ...
  documents: {
    privacy: {
      ...
      sections: [
        ...
        { title: "4. Hesap ve kimliklendirme", paragraphs: ["Albor parola ile giriş yapılan bir kullanıcı hesabı oluşturmaz. Girdiğiniz ad ve e-posta adresi; okuma etkinliğiniz ve rozetlerinizle birlikte bir uygulama profil kaydı olarak saklanır."] },
        { title: "5. Üçüncü taraf hizmetleri", paragraphs: ["Albor, veritabanı ve backend hizmet sağlayıcısı olarak Supabase kullanır. Supabase, yukarıda açıklanan bulut verilerini Albor adına işler ve bu politika ile yürürlükteki mevzuata uygun koruma sağlaması beklenir.", "Bu politikanın tarihinde Albor ayrı bir reklam, takip, analiz veya crash raporlama hizmeti kullanmamaktadır. Bu durum değişirse politika ve App Store gizlilik beyanları güncellenecektir."] },
        ...
        { title: "7. Saklama, güvenlik ve yurt dışı işleme", paragraphs: ["Bulut verileri Albor’u sunmak, talepleri sonuçlandırmak ve yasal yükümlülükleri yerine getirmek için gerekli olduğu sürece ya da geçerli bir silme talebi tamamlanana kadar saklanır. Yerel ses kayıtları, mevcut uygulama veya cihaz kontrolleriyle kaldırılana kadar cihazınızda kalır; cihaz yedekleme ayarlarınız farklı sonuç doğurabilir.", "Supabase altyapısının bulunduğu ülkelerde veri işlenebilir. Makul teknik ve idari önlemler uygulanır; ancak hiçbir saklama veya aktarım yöntemi için mutlak güvenlik garanti edilemez."] },
        { title: "8. Tercihleriniz ve haklarınız", paragraphs: [`Albor’da tutulan ad, e-posta adresi, okuma geçmişi ve rozetler için erişim, düzeltme veya silme talebinizi ${email} adresine gönderebilirsiniz. Verinizi korumak için kayıtla ilişkili e-posta adresini doğrulamanız istenebilir.`, "Albor’u kullanmayı bırakarak gelecekteki veri toplamayı durdurabilirsiniz. Cihazdaki ses kayıtları cihazınızdan yönetilir ve bulut silme sürecine dahil değildir."] },
    ...
    support: {
      ...
      sections: [
        ...
        { title: "E-postaya eklemeniz faydalı olacak bilgiler", bullets: ["Sorunun kısa açıklaması.", "İlgiliyse cihaz modeli ve işletim sistemi sürümü.", "Sorunun yaşandığı ekran veya özellik.", "Talebiniz bulutta saklanan verilerle ilgiliyse Albor’a girdiğiniz e-posta adresi."] },
        ...
        { title: "Gizlilik ve veri silme", paragraphs: [`Ad, e-posta adresi, okuma geçmişi ve rozetlerinize erişim, düzeltme veya silme için Veri Silme sayfasını kullanın ya da ${email} adresine yazın.`] },
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "4. Girdiğiniz bilgiler", paragraphs: ["Girdiğiniz ad ve e-posta adresinin doğruluğundan siz sorumlusunuz. Albor parola tabanlı bir giriş hesabı sunmaz. Bilgilerinizin işlenmesi Gizlilik Politikası’nda açıklanır."] },
    ...
    deletion: {
      ...
      updated: "18 Temmuz 2026",
      sections: [
        { title: "Silinebilen veriler", bullets: ["Adınız ve e-posta adresiniz.", "Saklanan okuma geçmişiniz.", "Kazandığınız rozet kayıtları."] },
        { title: "Silme talebi nasıl yapılır?", paragraphs: [`Albor’a girdiğiniz e-posta adresinden ${email} adresine “Albor Data Deletion Request” konulu bir e-posta gönderin. Bu e-posta adresiyle ilişkili Albor profil verilerinin silinmesini istediğinizi belirtin.`] },
        { title: "Doğrulama ve tamamlanma", paragraphs: ["Albor, silme işleminden önce kayıtla ilişkili e-posta adresini doğrulamanızı isteyebilir. Doğrulamanın ardından yasal olarak saklanması gerekmeyen ilişkili bulut verileri silinir ve işlem tamamlandığında size bilgi verilir."] },
        { title: "Cihazınızdaki ses kayıtları", paragraphs: ["Ses kayıtları cihazda yerel olarak tutulur ve Supabase’e yüklenmez. Mevcut uygulama veya cihaz kontrolleriyle kayıtları kaldırabilirsiniz. Uygulamayı silmek, cihaz ve yedekleme ayarlarınıza bağlı olarak uygulama içindeki yerel verileri normalde kaldırır."] },
