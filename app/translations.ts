...
const tr: Copy = {
  ...
  hero: { eyebrow: "Her gün yeni bir kıvılcım", titleStart: "Her gün bir fikir,", titleEm: "daha açık", titleEnd: "bir bakış.", body: "Albor, güçlü kitaplardan ve gerçek hikâyelerden gelen fikirleri birkaç dakikada okuyup düşünebileceğin kısa deneyimlere dönüştürür.", primary: "Uygulamayı indir", secondary: "Nasıl çalışır?", proof: "Düşünmek için daha çok zaman değil, daha iyi bir başlangıç.", visualAria: "Albor uygulamasından ekranlar", reading: "Bugünün seçkisi", conversation: "Sohbette Kullan", conversationNote: "Fikri hayatına taşı", foot: ["Güçlü kitaplar ve gerçek hikâyeler", "Her gün, sana özel", "Okunur · Dinlenir · Düşünülür"] },
  ...
  how: { eyebrow: "Nasıl çalışır?", titleStart: "Meraktan alışkanlığa,", titleEm: "üç küçük adımda.", steps: [["Konunu seç", "Finans, psikoloji, felsefe, liderlik, tarih, bilim, iletişim, üretkenlik, iş dünyası ve gelişim gibi kategorilerden keşfet."], ["Kısa bir hikâye oku veya dinle", "Fikrin özünü dakikalar içinde al; sesli anlatım ile dinlemeye devam et."], ["Düşün ve hayata taşı", "Önemli fikrini sakla, kendi notunu ekle, sohbet içinde kullanmak için anlatımını hazırla veya paylaşılabilir karta dönüştür."]] },
  featuresHeading: { kicker: "Albor deneyimi", titleStart: "Merakına eşlik eden", titleEm: "kişisel bilgi alanın." },
  features: [
    { eyebrow: "Günün seçkisi", title: "Her güne uygun, kısa ve odaklı hikâyeler.", body: "Günün ritmine uyan seçkilerle, güçlü fikirler için küçük ve sakin bir alan aç.", note: "Her gün yeni bir başlangıç", alt: "Albor ana ekranında günün seçkisi" },
    { eyebrow: "Sesli anlatım", title: "Okumak yerine dinlemeye devam et.", body: "Hikâyenin özünü kendi hızında oku veya sesli anlatımla günün akışında dinle.", note: "Oku veya sesli dinle", alt: "Albor uygulamasında sesli hikâye ekranı" },
    { eyebrow: "Kişisel kütüphane", title: "Dönmek istediğin her fikir, tek yerde.", body: "Kaydedilen hikâyeler, okuma geçmişi ve kişisel notlar; kendi düşünce arşivinde birlikte dursun.", note: "Kaydedilenler, geçmiş ve notlar", alt: "Albor kişisel kütüphane ekranı" },
    { eyebrow: "Kıvılcım Yolu", title: "Küçük okumaları kalıcı ilerlemeye dönüştür.", body: "Okuma, derinleşme ve uygulama davranışların; gelişimini görünür kılan adımlara dönüşür.", note: "İlerleme adımları ve rozetler", alt: "Albor gelişim ve ilerleme ekranı" },
    { eyebrow: "Sohbette Kullan", title: "Bir fikri daha doğal anlatmaya hazırlan.", body: "Anlatım varyasyonları ve pratikle fikirleri toplantıda, aile içinde veya sosyal ortamda kendine ait bir dille kullan.", note: "Paylaşılabilir kartlar ve Premium araçlar", alt: "Albor profil ve öğrenme araçları ekranı" },
  ],
  category: { kicker: "Keşfet", titleStart: "Merak ettiğin her konu için", titleEm: "yeni bir kıvılcım.", body: "Finans, psikoloji, felsefe, liderlik, tarih, bilim, iletişim, üretkenlik, iş dünyası ve gelişimden sana uyan bir başlangıç seç.", names: ["Psikoloji", "Felsefe", "Finans", "Liderlik", "Tarih", "Bilim", "İletişim", "Üretkenlik", "İş Dünyası", "Gelişim"] },
  ...
  faq: { kicker: "Merak edilenler", titleStart: "Aklında", titleEm: "soru kalmasın.", body: "Albor deneyimine dair en sık sorulan soruları burada yanıtladık.", ready: "Başlamaya hazırım", items: [["Albor nedir?", "Albor, güçlü kitaplardan ve gerçek hikâyelerden gelen fikirleri kısa ve etkili okuma deneyimlerine dönüştüren bir mobil uygulamadır."], ["Ücretsiz kullanım var mı?", "Uygulamadaki güncel ücretsiz erişim kapsamı mağaza ve uygulama içindeki ekranlarda açıkça gösterilir."], ["Premium neleri açar?", "Premium; sınırsız hikâye, tüm kategoriler, sesli anlatım, kişisel öğrenme araçları ve reklamsız deneyim sunar. Güncel koşullar uygulama içinde yer alır."], ["Sesli anlatım var mı?", "Evet. Uygun olduğunda hikâyeleri okuyabilir veya sesli anlatımla dinleyebilirsin."], ["Abonelik nasıl iptal edilir?", "Aboneliğini Apple App Store veya Google Play hesap ayarlarından yönetebilir ve iptal edebilirsin. İptal, sonraki yenilemeyi durdurur."], ["Destekle nasıl iletişime geçilir?", "Hesap, abonelik, içerik veya teknik sorunlar için destek sayfasındaki formu kullanabilir ya da destek e-postasına yazabilirsin."]] },
